            ...
            <div className="rounded-2xl border border-coal-700/60 bg-coal-950/50 p-4">
              ...
              {leader ? (
                <div className="mt-2.5 flex items-center gap-3">
                  <TeamCrest name={leader.teamName} players={[leader.player1, leader.player2]} size="md" zoomable={false} />
            ...
            <div className="rounded-2xl border border-coal-700/60 bg-coal-950/50 p-4">
              ...
              {next ? (
                <div className="mt-2.5 flex items-center justify-center gap-3">
                  <TeamCrest name={next.homeTeam.name} players={[next.homeTeam.player1, next.homeTeam.player2]} size="sm" zoomable={false} />
                  ...
                  <TeamCrest name={next.awayTeam.name} players={[next.awayTeam.player1, next.awayTeam.player2]} size="sm" zoomable={false} />
                </div>
              ) : (
